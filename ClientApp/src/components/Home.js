...
render() {
    ...
    let contents = this.state.loading
        ? <p><em>Loading...</em></p>
        : Home.renderAppointmentsTable(this.state.appointments, 'https://meetupcall.herokuapp.com/?doctor='+this.state.userName+'&patient=Jhon');

    return (
        <div>
            <div class="table-heading text-center my-3 pt-5">
